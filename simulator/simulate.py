...
# using 1 hour now
def generate_customer_list(total_time=3600):
    """
    Generates a list of customers for total time.
    """
    expon_vars = gen_expon(500)
    time_so_far = 0.0
    customers = []
    ...
    #     print(f"Prob: {pick_up_zones[i][1]}\n\n")

    #     print(f"Customer name: {customers[mid_point + i].name}")
    #     print(f"Customer arrival: {customers[mid_point + i].arrival}")
    #     print(f"Customer pickup: {customers[mid_point + i].pickup}")
    #     print(f"Customer dropoff: {customers[mid_point + i].dropoff}")
    #     print(f"Prob: {pick_up_zones[mid_point + i][1]}\n")
    #     print("----------------------------------------------")
    # i = -1
    # print(f"Customer name: {customers[i].name}")
    # print(f"Customer arrival: {customers[i].arrival}")
